...
- Create a `your_feature.csv` file in the `language_examples/` folder. Once it is created, add code to it that demonstrates your feature (more demonstration the better).
...
```json
{
    ...
    "name": "punctuation.separator.attribute.csv",
    "patterns": [
        {
...
```json
{
    ...
    "beginCaptures": {
        "0": {
            "name": "punctuation.section.attribute.begin.csv"
        }
    },
    "endCaptures": {
        "0": {
            "name": "punctuation.section.attribute.end.csv"
        }
    },
    "name": "support.other.attribute.csv",
    "patterns": [
        {
